        ...
        <div>
           <div className="container w-75 mb-5   " >
                <div className="d-flex justify-content-between ">
                    <h1 className="fw-bolder title"> today's deals</h1> 
                                   ...
                                   <div className="card h-100 py-3 d-block   rounded-4  shadow  " key={e.id}  >
                                       ...
                                       <div className=" d-block p-3   " >
                                          <div className="d-flex justify-content-around mx-auto " >  
                                            ...
                                            <button className="btn btn-info w-50 rounded-4 btn-sm  " onClick={()=>{localStorage.setItem(e.id , e.title)}} > <Link to={`/${e.id}`} className=" text-decoration-none fw-bold text-light  "> show Details </Link> </button>
                                            <div></div>
                               ...
                               <div className="card h-100 py-3 d-block   rounded-4  shadow  " key={e.id}  >
                                   ...
                                   <div className=" d-block p-3   " >
                                      <div className="d-flex justify-content-around mx-auto " >  
                                        ...
                                        <button className="btn btn-info w-50 rounded-4 btn-sm  "   > <Link to={`/${e.id}`} className=" text-decoration-none text-light fw-bold   "> show Details </Link> </button>
